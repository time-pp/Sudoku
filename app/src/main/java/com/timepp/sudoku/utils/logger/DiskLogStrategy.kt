...
class DiskLogStrategy(private val handler: Handler) : LogStrategy {
    ...
    internal class WriteHandler(looper: Looper, private val folder: String,
                                private val maxFileSize: Int): Handler(looper) {
        ...
        private fun getLogFile(folderName: String, fileName: String): File {
            ...
            return if (existingFile != null && existingFile.length() < maxFileSize)
                existingFile else newFile
        }
